...
PATH_TO_LABELS = os.path.join('/home/pi/Desktop/ObjectDectect/object_detection/data', 'mscoco_label_map.pbtxt')
NUM_CLASSES = 90
fileAlreadyExists = os.path.isfile(PATH_TO_FROZEN_GRAPH) 
